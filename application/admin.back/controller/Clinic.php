<?php
	...
	public function getLevelChild($pid=0)
	{
		...
		$pids=db('Clinic')->where('pid',$pid)->select();
	}
	
		
	public function lst()
	{
			$list=db('Clinic')->paginate();
	...
	public function updhanddle()
	{
		...
		$re=db('Clinic')->where('cancer_id',$id)->update($data);
		if($re){
