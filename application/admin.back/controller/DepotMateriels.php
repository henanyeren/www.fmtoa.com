...
public function typeupdhanddle(){
	...
	public function history(){
		...
		//dump($materiel_list);die;
		//判断关联出出库后，剩余批次
		$DepotPressMaterielsGoods_model=model('DepotPressMaterielsGoods');
		
//		foreach($materiel_list as $k=>$v){
//			
//			
//				$DepotPressMaterielsGoods_obj=$DepotPressMaterielsGoods_model->get($v['materiel_id']);
//				$DepotPressMaterielsGoods_obj->DepotMaterielsGoods;				
//				$arr=$DepotPressMaterielsGoods_obj->toArray();
//				$materiel_list[$k]['current_batch_number']=$arr['DepotMaterielsGoods']['materiel_number'];
//			
//		}
	//	dump($materiel_list);die;
		if($materiel_list){
