<?php
	...
	class Ntfs extends Common{
		...
		public function getLevelChild($pid=0)
		{
			...
			$pids=db('Ntfs')->where('pid',$pid)->select();
		}
	
		
	public function lst()
	{
			$list=db('Ntfs')->paginate();
	...
	public function updhanddle()
	{
		...
		$re=db('Ntfs')->where('cancer_id',$id)->update($data);
		if($re){
