...
var Role = /** @class */ (function (_super) {
    ...
    function Role() {
        ...
        //判断大boss出来时间
        _this.shootTimes = Laya.Browser.now() + 2000;
        //当前动作
        _this.action = "";
        //是否是子弹
    ...
    Role.prototype.init = function (_type, _camp, _hp, _speed, _hitRadius, _heroType) {
        ...
        if (!Role.cached) {
            ...
            //缓存敌机3飞行动画
            Laya.Animation.createFrames(["war/enemy4_fly1.png", "war/enemy4_fly2.png"], "enemy4_fly");
            //缓存敌机3爆炸动作
            Laya.Animation.createFrames(["war/enemy4_down1.png", "war/enemy4_down2.png", "war/enemy4_down3.png",
                "war/enemy4_down4.png", "war/enemy4_down5.png", "war/enemy4_down6.png"], "enemy4_down");
            //缓存敌机3碰撞动作
            Laya.Animation.createFrames(["war/enemy4_hit.png"], "enemy4_hit");
            //缓存子弹动画
